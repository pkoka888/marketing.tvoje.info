...
This document provides comprehensive resource requirements for popular image
generation models including SDXL, Stable Diffusion 1.5, FLUX, and ComfyUI.
...
Note: System RAM is used for the operating system, Python interpreter, model
loading/swapping, and VRAM offloading.
