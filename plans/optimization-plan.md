...
```json
{
  "mcpServers": {
    ...
    "filesystem-agentic": {
      "command": "npx",
      "args": ["-y", "@modelcontextprotocol/server-filesystem", "C:/Users/pavel/vscodeportable/agentic"]
    }
  }
}
```
...
```json
{
  "mcpServers": {
    "filesystem-projects": {
      "command": "npx",
      "args": ["-y", "@modelcontextprotocol/server-filesystem@latest", "${PROJECTS_PATH:C:/Users/pavel/projects}"],
      "alwaysAllow": ["read_text_file", "list_directory", "directory_tree", "read_multiple_files"],
      "timeout": 30000,
      "env": {
    ...
    "filesystem-agentic": {
      "command": "npx",
      "args": ["-y", "@modelcontextprotocol/server-filesystem@latest", "${AGENTIC_PATH:C:/Users/pavel/vscodeportable/agentic}"],
