...
### Phase 5. Final Polish & Audit (Phase 8)

- [x] Fix Git line endings (`.gitattributes`).
- [x] Verify `lighthouserc.json`.
- [ ] Add Astro component integration tests (Requires `@astrojs/vitest` setup).
- [x] Prune/Document active BMAD workflows.
