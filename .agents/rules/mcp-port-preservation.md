...
MCP (Model Context Protocol) servers must use non-standard ports to avoid conflicts with common services. This rule prevents accidental port changes that can cause service disruptions.
